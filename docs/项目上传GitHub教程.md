...
1. 解压 `ime-dictionary-exporter-source-1.1.1.zip`，把里面的项目文件上传到同一个源码仓库的 `main` 分支。
...
在同一仓库创建 Release，标签例如 `v1.1.1`，对应此次上传的代码，附上 `ime-dictionary-exporter-offline-1.1.1.zip`。使用者解压后双击“打开词库.html”即可。
